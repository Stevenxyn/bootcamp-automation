...
public class MathClass {
	public static void main(String[] args) {
		...
		System.out.println("Math.floor: " + resultFloor);
		...
		System.out.println("Math.Max: saber el mayor de dos numeros: " + resultMax);
		System.out.println("Saber la cantidad de valores de un string: " +resultStrings);

		// Esto devuelve el menor de dos numeros
		resultMin = Math.min(45.5, 45.9);
		System.out.println("Saber el minimo de dos numeros: " + resultMin);
